                ...
                <div class="card" style="height:521px;width: 279px;">
                                ...
                                <div class="content1">
                                        ...
                                        <div class="boxed"><a href="${NormalProjectViewImages}}"> <img class="picture"
                                                        src="${NormalProjectImageResourceURL}" alt="Image"
                                                        style="height: 191px; width: 278px; margin-left: -21px; margin-top: -10px;" />
                                                </a></div>
...
%>
		...
		<div>
			<a href="/web/crowd-funding/campaigns" style="float:right; font-size: 20px; color: #287d3d;    text-decoration: underline;">Read More...</a>
		</div>
	</div>
	<!--end of section 2-->
	...
	<div class="section 3 content " id="grad2" style="height:525px;">
		<!--start of section3-->
		<br/>
		...
		<div class="slideshow-container1">
			...
			<div>
			<img class="trial" src="\portal_content\Education.jpg" style="width:18%;height:40%;margin-left:180px;border:6px solid black;margin-top:160px;max-height:250px;" /></div>
				<div class="text_section2">" Thank you for helping me fulfill my dreams to go to school"</div>
			</div>
			<!--close of myslides1 fade1-->

			<div class="mySlides1 fade1"><img class="trial1" src="\portal_content\kid_hospital.jpg" style="width:18%;height:40%; margin-left:180px;border:6px solid black;margin-top:160px;max-height:250px;" />
				<div class="text_section2">" Thank you for helping me to get well soon"</div>
			</div>
			<!--close of myslides1 fade1-->

			<div class="mySlides1 fade1"><img class="trial2" src="\portal_content\agri_draught.jpg" style="width:18%;height:40%;margin-left:180px;border:6px solid black;margin-top:160px;max-height:250px;" />
	...
	<div class="section5 content" style="position: relative; left: 0; top: 0;"><img class="fishes" src="\portal_content\qd_flow.jpg" style="width:100%; height:50%;" /></div>
...
<div class="slide"><img class="disability" src="\portal_content\inclusivity.jpg" style="width:100%;height:200px;border-radius:100%;border:5px solid #0077A2;" /> <a href="" style="font-size: 1.1vw;margin-left:50px;color:#0077A2;margin-left:40px;">Disabality</a></div>
