...
<aui:form action="${otpAuthenticationURL}" method="post" >
   ...
   <center><h1 style="color:#0077A2;"> OTP VALIDATION FORM </h1> </center>
	...
	<%} %>
	<center><aui:button type="submit"  name="Submit OTP" onClick="<portlet:namespace/>validate()"value="Submit OTP" style="background-color:#0077A2;border-radius: 22px;width: 108px;height: 39px; color:white;"/>
	</br></br></center>
