...
<br>
<br>
<center><aui:button type="submit" value="Finish"  style="background-color:#0077A2;color:white;border-radius: 100px;width: 100px;"  onClick="/web/quickdaan-home-page/home"  /></center>
</div>