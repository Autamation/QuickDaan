...
<p>
	...
	<b style="font-size: 30px; color: #2e5aac;"><liferay-ui:message key="Sign In"/></b>
</p>
...
<c:choose>
	...
	<c:otherwise>
		...
		<aui:form action="<%= loginURL %>" autocomplete='on' cssClass="sign-in-form" method="post" name="loginForm">
			...
			<aui:input autoFocus="true" cssClass="clearable" label="" placeholder="Enter Username" name="login"  type="text" value="" style="width: 23%;">
				<aui:validator name="required" />
			</aui:input>

			<aui:input name="password" label="" placeholder="Enter password" type="password" style="width: 23%;">
				<aui:validator name="required" />
			</aui:input>
			
			<a href="/web/guest/home?p_p_id=com_liferay_login_web_portlet_LoginPortlet&p_p_lifecycle=0&p_p_state=maximized&p_p_mode=view&_com_liferay_login_web_portlet_LoginPortlet_mvcRenderCommandName=%2Flogin%2Fforgot_password" class="forgot-link" style=" color: #337ab7;">Forgot your password?</a>
			...
			<a href="/web/customelogin/registration" class="forgot-link" style=" color: #337ab7;">Create Account</a>
			<aui:button-row>
