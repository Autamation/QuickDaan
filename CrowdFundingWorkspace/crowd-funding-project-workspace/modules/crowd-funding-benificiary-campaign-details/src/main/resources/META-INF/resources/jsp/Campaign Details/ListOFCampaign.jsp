...
<liferay-ui:success key="success-Amt" message="Thank you for your Contribution! Sign up to support and be updated about your favourite causes and organisations. " />

<!-- Featured Project -->
<div class="campaignpagelist" style="margin-top: -48px;">

	<div style="color: #0077a2;">
		<center>
			<h4>
				<b> Trending Fundraisers </b>
			</h4>
	...
	<div class="row">
		...
		<portlet:renderURL var="featuredProjectViewImages"
			...
			<portlet:param name="jspPage"
				value="/jsp/Campaign Details/CampaignDetails.jsp" />
		</portlet:renderURL>
