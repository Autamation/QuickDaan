...
<%
int counter = 1;
List<ProjectExtentionRegistration> projectExtendedList = ProjectExtentionRegistrationLocalServiceUtil.findBySTATUS(CrowdFundingBenificiaryDetailsPortletKeys.CAMPAIGN_DAYS_EXTENDED_STATUS_1);
...
<form >
<table id="exampleDaysExtended" class="display" style="width:100%">
		<thead>
			<tr>
				<th>No.</th>
