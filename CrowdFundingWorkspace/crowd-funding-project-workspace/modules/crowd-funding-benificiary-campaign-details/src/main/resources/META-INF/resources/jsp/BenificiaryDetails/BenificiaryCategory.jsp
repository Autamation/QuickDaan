		...
		<div>
			<div class="testimotionals content " style="float: center;">
				<div class="card" style="height: 335px;">
					...
					<div class="content1">
						<p
							style="color: white; font-size: 1.5vw; font-family: georgia; height: 25px; width: 100%;">Individual</p>

						<div class="boxed">
							<img src="\portal_content\hunger.jpg" style="width: 100%; height: 100%;" />
						</div>
						...
						<div class="details">
							<div class="para">
								<p
									style="font-size: 1.1vw; margin-top: 10px; color: white; font-family: georgia;">Individual
									Register here....!</p>
							</div>
							<!--end of para-->
						</div>
				...
				<center>
					<p style="font-size: 1vw;">
						<!-- <button accesskey=""
							style="border: 1px solid #7FBD2C; margin-top: 5px; border-radius: 20px; background-color: #7FBD2C; color: black; width: 50%; height: 40px; font-family: georgia;">Individual</button> -->
							<aui:button cssClass="borderForm2" type="button" onClick="${IndividualURL}" value="Individual" style="border: 1px solid #7FBD2C; margin-top: 5px; border-radius: 20px; background-color: #7FBD2C; color: black; width: 50%; height: 40px; font-family: georgia;"/>
					</p>
				</center>
				<!--end of card-->
			</div>
			...
			<div class="testimotionals content " style="float: center;">
				<div class="card" style="height: 335px;">
					...
					<div class="content1">
						<p
							style="color: white; font-size: 1.5vw; font-family: georgia; height: 25px; width: 100%;">Organisation</p>
						...
						<div class="details">
							<div class="para">
								<p
									style="font-size: 1.1vw; margin-top: 10px; color: white; font-family: georgia;">Organisation
									Register here....!</p>
							</div>
							<!--end of para-->
						</div>
				...
				<center>
					<p style="font-size: 1vw;">
						<!-- <button accesskey=""
							style="border: 1px solid #7FBD2C; margin-top: 5px; border-radius: 20px; background-color: #7FBD2C; color: black; width: 50%; height: 40px; font-family: georgia;">Group</button> -->
							<aui:button cssClass="borderForm2" type="button" onClick="${GroupURL}" value="Organisational" style="border: 1px solid #7FBD2C; margin-top: 5px; border-radius: 20px; background-color: #7FBD2C; color: black; width: 50%; height: 40px; font-family: georgia;"/>
					</p>
				</center>
				<!--end of card-->
			</div>
...
<div class="BenificaryCategory">
	...
	<aui:button cssClass="borderForm2" type="button" onClick="${GroupURL}" value="Organisational" />
