...
<aui:input name="projectID" type="hidden" value="<%= projectObj.getPROJECT_ID() %>"></aui:input>
	...
	<table>
		<tr>
			<td>
				<img src="${imageResourceURL}" alt="Image" class="rounded-circle" alt="Img" style="margin-right: 529px;margin-top: -16px;width: 142px;height: 133px;"/>
			</td>
			<td><br/>
				<strong><h1 style="color:#0077A2;margin-left:-293%;"> <%= projectObj.getTITLE() %></h1><!-- Title : --></strong>
				<strong style="margin-left:-58px;color:#0077A2;font-size:1.1rem;">Creation Date :</strong> <strong style="font-size:1.1rem;"> <%= formatter.format(projectObj.getCREATION_DATE()) %></strong><br>
				<strong style="margin-left:-58px;color:#0077A2;font-size:1.1rem;">End Date :</strong> <strong style="font-size:1.1rem;"> <%= formatter.format(projectObj.getEND_DATE()) %></strong><br><br>
			</td>
		</tr>
	 </table>
	 ...
	 <div><b><h3 style="font-size: 1.2rem;padding: 2px;color: darkgreen;">Project Owner Details</h3></b></div><br>
	 ...
	 <div style="border: 1px solid #6c757d1a;border-bottom: 3px solid #6c757d1a;border-right: 3px solid #6c757d1a; border-radius: 8px;box-shadow: 0 1px 26px 0 rgba(0, 0, 0, 0.32);padding: 22px;margin-top: 72px;">
	 
	 <div><b><h3 style="font-size: 1.2rem;padding: 2px;color: darkgreen;">Benificiary Details</h3></b><br></div>
	...
	<div style="background: #dcdcdc38;border: 1px solid #6c757d1a;border-bottom: 3px solid #6c757d1a;border-right: 3px solid #6c757d1a; border-radius: 8px;box-shadow: 0 1px 26px 0 rgba(0, 0, 0, 0.32);padding: 22px;margin-top: 72px;">
	 ...
	 <div><b><h3 style="font-size: 1.2rem;padding: 2px;color: darkgreen;">Story</h3></b></div><br>
	...
	<div style="background: #dcdcdc38;border: 1px solid #6c757d1a;border-bottom: 3px solid #6c757d1a;border-right: 3px solid #6c757d1a; border-radius: 8px;box-shadow: 0 1px 26px 0 rgba(0, 0, 0, 0.32);padding: 22px;margin-top: 72px;">
	 ...
	 <div><b><h3 style="font-size: 1.2rem;padding: 2px;color: darkgreen;">Project Updates</h3></b><br></div>
...
<%-- 	<div style="background: #dcdcdc38;border: 1px solid #6c757d1a;border-bottom: 3px solid #6c757d1a;border-right: 3px solid #6c757d1a; border-radius: 8px;box-shadow: 0 1px 26px 0 rgba(0, 0, 0, 0.32);padding: 22px;margin-top: 72px;">
	...
	try{
		...
		<div><b><h3 style="font-size: 1.2rem;padding: 2px;color: darkgreen;">Project Acknowlegement</h3></b></div>
			<tr>
